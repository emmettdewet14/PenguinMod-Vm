...
test('parseVectorMetadata', t => {
    ...
    t.same(
        ...
        {
            source: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"></svg>',
            rotationCenter: [0, 0]
        }
    );
    t.same(
    ...
    t.same(
        ...
        {
            source: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"></svg>',
            rotationCenter: [106.62300344745225, -11.822572945859918]
        }
    );
    t.same(
...
test('exportCostume', t => {
    ...
    t.same(exportCostume({
        ...
        80,
        90,
        ...'<!--rotationCenter:89.339393:-3.7373-->'.split('').map(i => i.charCodeAt(0))
    ]));
